 ...
 * @generated
 */
public class BankingModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BankingModelPackage.ADMINISTRATOR_PROVIDES: {
