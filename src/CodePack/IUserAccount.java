...
public interface IUserAccount extends IBookings {
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" ordered="false" e_mailRequired="true" e_mailOrdered="false" phone_noRequired="true" phone_noOrdered="false"
	 * @generated
	 */
	boolean updateCustomerInfo(String e_mail, String phone_no);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" ordered="false" e_mailRequired="true" e_mailOrdered="false" passwordRequired="true" passwordOrdered="false" date_of_birthRequired="true" date_of_birthOrdered="false" phone_noRequired="true" phone_noOrdered="false"
	 * @generated
	 */
	boolean registerCustomer(String e_mail, String password, Date date_of_birth, int phone_no);
